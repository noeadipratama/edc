                    ...
                    <div class="panel panel-default">
                      ...
                      <th nowrap>Status</th>
                                    ...
                                    <?php
                                                        ...
                                                        foreach ($menu_details_access->result() as $rows) {
                                                      ?>
                                                        <tr >
                                                                                <td nowrap><a href="menu_details_access/delete/<?= $rows->id_menu_details_access?>">
                                                                                    <button class="btn btn-primary" >
                                                                                        Delete
                                                                                    </button></a>
                                                                                    <a href="menu_details_access/formupdate/<?= $rows->id_menu_details_access?>">
                                                                                    <button class="btn btn-primary" >
                                                                                        Update
                                                                                    </button></a>                                                        
                                                                                </td>
                                                          <td><?= $rows->id_menu_details_access?></td>
                                                          <td><?= $rows->nm_level?></td>
